...
ユーザーは動物園から提供されるニュースやレッサーパンダの写真（オープンデータ）を活用して、独自のデジタルキャンバスページを作成・公開できます。

### 主な機能

- **キャンバス作成**: ドラッグ&ドロップで簡単にレイアウト作成
- **1ユーザー1キャンバス**: 無料プランでは各ユーザーは1つのキャンバスのみ作成可能
- **リアルタイム更新**: WebSocketによる自動コンテンツ更新
- **公開/非公開設定**: キャンバスの公開状態を管理
- **通報機能**: 不適切なコンテンツを事後通報
