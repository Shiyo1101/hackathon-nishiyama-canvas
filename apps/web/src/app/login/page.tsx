...
import { SocialLoginContainer } from "@/features/login";
      ...
      <div className="z-10 flex w-full max-w-md flex-col px-4 py-10">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-3">
            <SocialLoginContainer provider="google" className="h-14 w-full" />
            <SocialLoginContainer provider="discord" className="h-14 w-full" />
            <SocialLoginContainer provider="line" className="h-14 w-full" />
          </div>
