...
async function main() {
    ...
    data: [
      {
        ...
        category: "お知らせ",
        imageUrl: "https://example.com/news/baby-panda.jpg",
      ...
      },
      {
        ...
        category: "イベント",
        imageUrl: "https://example.com/news/winter-event.jpg",
      ...
      },
      {
        ...
        summary: "飼育員インタビュー記事",
        category: "特集",
        imageUrl: "https://example.com/news/keeper-interview.jpg",
  ...
  const images = await prisma.animalImage.createMany({
    data: [
      {
        animalId: panda1.id,
        imageUrl: "https://example.com/animals/panda-taro-1.jpg",
        thumbnailUrl: "https://example.com/animals/thumbs/panda-taro-1.jpg",
        caption: "木登りをするパンダ太郎",
        isFeatured: true,
      },
      {
        animalId: panda1.id,
        imageUrl: "https://example.com/animals/panda-taro-2.jpg",
        thumbnailUrl: "https://example.com/animals/thumbs/panda-taro-2.jpg",
        caption: "リンゴを食べるパンダ太郎",
        isFeatured: false,
      },
      {
        animalId: panda2.id,
        imageUrl: "https://example.com/animals/panda-hanako-1.jpg",
        thumbnailUrl: "https://example.com/animals/thumbs/panda-hanako-1.jpg",
        caption: "日向ぼっこするパンダ花子",
        isFeatured: true,
      },
      {
        animalId: panda2.id,
        imageUrl: "https://example.com/animals/panda-hanako-2.jpg",
        thumbnailUrl: "https://example.com/animals/thumbs/panda-hanako-2.jpg",
        caption: "竹を食べるパンダ花子",
        isFeatured: false,
      },
    ],
